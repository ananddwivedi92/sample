...
<!-- Common Menu  Ends-->
	<div class="inner_left">
		...
		<p><b>Message: ${message}</b></p>
			<form name="form" action="StudentAdmissionServlet" method="post"
				...
				<table style="width: 100%" cellpadding="5">
					<tbody>
						<tr>
							<td style="width: 150px" width="294"><strong>Name:
									<span class="pflichtfeld">*</span>
							</strong></td>
							<td width="348"><input name="studentName" type="text"
								class="dis_f_in" style="width: 260px" value="" maxlength="100"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Father Name: <span
									class="pflichtfeld">*</span></strong></td>
									
							<td><input name="fatherName" type="text" class="dis_f_in"
								style="width: 260px" value="" maxlength="100"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Mother Name:</strong></td>
							
							<td><input name="motherName" type="text" class="dis_f_in"
								value="" style="width: 260px" maxlength="50"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Date of Birth: <span
						...
						<tr>
							<td style="width: 150px"><strong>Category : <span
									class="pflichtfeld">*</span>
							</strong></td>
						...
						<tr>
							<td style="width: 150px"><strong>Residence:</strong></td>
							<td><input name="residence" type="text" value=""
								class="dis_f_in" style="width: 260px" maxlength="50"></td>
						</tr>

						<tr>
							<td style="width: 150px"><strong>Income
									Certificate(With Doc upload):</strong></td>
									
							<td><input name="incomeCertificate" type="text" value=""
								class="dis_f_in" style="width: 260px" maxlength="50"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Course date of
									Admission:</strong></td>
									
							<td><input name="courseDate" type="text" value=""
								class="dis_f_in" style="width: 260px" maxlength="50"></td>
						</tr>

						<tr>
							<td style="width: 150px"><strong>Enroll Session
									Name:</strong></td>
									
							<td><input name="enrollSessionName" type="text" value=""
								class="dis_f_in" style="width: 260px" maxlength="50"></td>
						</tr>
						...
						<tr>
							...
							<td><input name="enrollSessionYear" type="text" value=""
								class="dis_f_in" style="width: 260px" maxlength="50"></td>
						</tr>
