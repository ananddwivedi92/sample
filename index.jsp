		...
		<p><b>Message: ${message}</b></p>
			<form name="form" action="RegisterServlet" method="post"
				...
				<table style="width: 100%" cellpadding="5">
					<tbody>
						<tr>
							<td style="width: 150px" width="294"><strong>Institute
									Name: <span class="pflichtfeld">*</span>
							</strong></td>
							<td width="348"><input name="instituteName" type="text"
								class="dis_f_in" style="width: 260px" value="" maxlength="100"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Group Name: <span
									class="pflichtfeld">*</span></strong></td>
							<td><input name="groupName" type="text" class="dis_f_in"
								style="width: 260px" value="" maxlength="100"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Registration No.:</strong></td>
							<td><input name="registrationNumber" type="text" class="dis_f_in"
								value="" style="width: 260px" maxlength="50"></td>
						</tr>
						<tr>
							<td style="width: 150px"><strong>Application For: <span
									class="pflichtfeld">*</span>
							</strong></td>
							<td><input name="applicationFor" type="text"
						...
						<tr>
							...
							<td><input name="mobileNumber" type="text" value=""
						...
						<tr>
							...
							<td><textarea name="address" cols="35" rows="5"
